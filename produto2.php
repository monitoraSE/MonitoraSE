...
<body class="body-produto1">
    ...
    <main class="main-produto1">
        ...
        <p class="plano__assinatura">Plano de Assinatura - <strong class="strong__plano">Plano Escolar 2</strong></p>
        ...
        <div class="ilustrativo__contratacao">
            ...
            <div class="funcionalidades">
                <h2>Plano Escolar 2</h2>

                <p class="preco">R$ 25,00 / aluno</p>
            ...
            <div class="card__assinar">
                ...
                <div>
                    <p>Total:</p>
                    <h2 class="preco">R$25,00/Aluno</h2>
                </div>
