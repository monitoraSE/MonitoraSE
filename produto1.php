...
<body class="body-produto1">
    ...
    <main class="main-produto1">
        ...
        <p class="plano__assinatura">Plano de Assinatura - <strong class="strong__plano">Plano Escolar 1</strong></p>
        ...
        <div class="ilustrativo__contratacao">
            ...
            <div class="funcionalidades">
                <h2>Plano Escolar 1</h2>

                <p class="preco">R$ 15,00 / aluno</p>
            ...
            <div class="card__assinar">
                ...
                <div>
                    <p>Total:</p>
                    <h2 class="preco">R$15,00/Aluno</h2>
                </div>
