<?php
    ...
    if((isset($_POST['cpf'])) && (isset($_POST['senha']))){
        $usuario = mysqli_real_escape_string($conecta, $_POST['cpf']); //Escapar de caracteres especiais, como aspas, prevenindo SQL injection
        $senha = mysqli_real_escape_string($conecta, $_POST['senha']);
        //$senha = md5($senha);
            
        //Buscar na tabela usuario o usuário que corresponde com os dados digitado no formulário
        $result_usuario = "SELECT * FROM Usuario WHERE CPF = '$usuario' && Senha = '$senha' LIMIT 1";
